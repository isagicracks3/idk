...
# Create the email
    ...
    headers = {
    'authority': 'minimalgear.com',
    'accept': '*/*',
    'accept-language': 'en-IN,en-GB;q=0.9,en-US;q=0.8,en;q=0.7,de;q=0.6',
    'content-type': 'application/x-www-form-urlencoded',
    
    'origin': 'https://minimalgear.com',
    'referer': 'https://minimalgear.com/products/cnocoutdoors-28mm-sport-cap-blue?variant=40373647474777',
    ...
    'utf8': '✓',
    'id': '40373647474777',
    'product-id': '6557401546841',
    'section-id': 'template--14980877549657__main',
}


    try:
        response = session.post('https://minimalgear.com/cart/add.js',  headers=headers, data=data)
    ...
    response = session.get('https://minimalgear.com/cart.js',  headers=headers)
    ...
    f'https://minimalgear.com/checkouts/cn/{chk_token}',
...
# Check if all tokens were found
    ...
    'payment_session_scope': 'cnocoutdoors.com',
}
    ...
    headers = {
    'authority': 'cnocoutdoors.com',
    'accept': 'application/json',
    'accept-language': 'en-US',
    'content-type': 'application/json',
    
    'origin': 'https://cnocoutdoors.com',
    'referer': 'https://cnocoutdoors.com/',
    'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-platform': '"Android"',
    'sec-fetch-dest': 'empty',
    ...
    'x-checkout-web-build-id': 'a25a42bb56f0549588bab4a21f953b848cee187a',
    ...
    'variables': {
                ...
                'deliveryLines': [
                    {
                        ...
                        'selectedDeliveryStrategy': {
                            'deliveryStrategyByHandle': {
                                'handle': '99e2857d07ed4affa186cddbce9a33de-3059c32c7089450f134427f0a3d5fd8d',
                ...
                'merchandiseLines': [
                    {
                        ...
                        'merchandise': {
                            'productVariantReference': {
                                'id': 'gid://shopify/ProductVariantMerchandise/40373647474777',
                                'variantId': 'gid://shopify/ProductVariant/40373647474777',
                                'properties': [],
                                'sellingPlanId': None,
        ...
        'attemptToken': f'{chk_token}-s9j1b32b2u',
        'metafields': [],
        'analytics': {
            'requestUrl': f'https://cnocoutdoors.com/checkouts/cn/{chk_token}',
            'pageId': '0b437aaf-F861-462F-C3B1-BC99C198B216',
        },
    },
    'operationName': 'SubmitForCompletion',
}
    ...
    'https://cnocoutdoors.com/checkouts/unstable/graphql',
    params=params,
...
#print(vbv("5122309403696807|09|2029|674"))                                     
# Example usage
